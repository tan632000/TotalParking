...
# Test candidate coords with bottom pushed up
pts = [
    (526, 211),  # top-left
    (632, 198),
    (718, 223),
...
print(f"Average distance to red borders: {avg_dist:.3f} pixels")
...
final_img.save('TotalParking/scratch/zone6_higher_verify.png')
print("Successfully generated zone6_higher_verify.png")
