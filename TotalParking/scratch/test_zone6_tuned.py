...
candidates = {
    "A (Bottom Y=410, Left X=573)": [(526, 211), (632, 198), (718, 223), (923, 235), (923, 410), (602, 410), (602, 380), (573, 380)],
    "B (Bottom Y=390, Left X=573)": [(526, 211), (632, 198), (718, 223), (923, 235), (923, 390), (602, 390), (602, 360), (573, 360)],
    "C (Bottom Y=380, Left X=573)": [(526, 211), (632, 198), (718, 223), (923, 235), (923, 380), (602, 380), (602, 350), (573, 350)],
    "D (Bottom Y=410, Left X=602)": [(526, 211), (632, 198), (718, 223), (923, 235), (923, 410), (602, 410), (602, 380), (602, 380)]
}
...
for name, pts in candidates.items():
    ...
    print(f"{name}: Loss = {avg_dist:.3f} px")

# Draw overlay of Candidate B (which corresponds to top of yellow corridor at Y=390)
...
draw_overlay.polygon(candidates["B (Bottom Y=390, Left X=573)"], fill=(34, 197, 94, 100), outline=(34, 197, 94, 255))

canvas_rgba = canvas.convert('RGBA')
final_img = Image.alpha_composite(canvas_rgba, overlay)
os.makedirs('TotalParking/scratch', exist_ok=True)
final_img.save('TotalParking/scratch/zone6_narrow_bottom_verify.png')
print("Successfully generated zone6_narrow_bottom_verify.png")
