...
# Old: 520,15 950,15 950,235 720,235 630,185 520,185
# idx 0: 520,15 -> SHARED (fixed to 571, 45)
# idx 1: 950,15 -> Free
# idx 2: 950,235 -> Free
# idx 3: 720,235 -> Free
# idx 4: 630,185 -> Free
# idx 5: 520,185 -> Free (should shift to meet vertical line around X=571)

current_pts = [
    (571, 45),       # 0 (fixed)
    (950+40, 15+30),  # 1 (initial guess with offset)
    (950+40, 235+30), # 2
    (720+60, 235+30), # 3
    (630+60, 185+30), # 4
    (571, 185+30)     # 5 (aligned with X=571)
]

free_indices = [1, 2, 3, 4, 5]
    ...
    for i in free_indices:
        ...
        for dx in range(-6, 7, 2):
            for dy in range(-6, 7, 2):
                if dx == 0 and dy == 0:
                    continue
                # For point 5, keep it locked to X=571 since it lies on the Zone 4 boundary line
                actual_dx = 0 if i == 5 else dx
...
# Zone 4 points
pts4 = [(343, 45), (571, 45), (571, 390), (412, 390), (412, 390), (372, 390), (372, 390), (308, 390), (278, 293), (308, 248)]
...
# Draw Zone 5 in Cyan (fill: rgba(6, 182, 212, 0.15), stroke: rgb(6, 182, 212))
...
final_img.save('TotalParking/scratch/zone5_verify.png')
print("Successfully generated zone5_verify.png")
